...
INSERT INTO Cliente (ativo, nome, cpf, data_nasc, phone, endereco, email, senha, dt_criacao)
VALUES (1, 'Gustavo Nava', 22211133344, '2001-11-26', 993218765, 'Florianopolis', 'gustavonava998@gmail.com', 876876, '2023-01-01 16:50:00')
INSERT INTO Cliente (ativo, nome, cpf, data_nasc, phone, endereco, email, senha, dt_criacao)
...
INSERT INTO Cliente (ativo, nome, cpf, data_nasc, phone, endereco, email, senha, dt_criacao)
VALUES (1, 'Lucia Mattos', 77754522871, '1992-05-05', 917284928, 'Florianopolis', 'luciamattosxd@gmail.com', 102876, '2014-03-27 14:15:00')
INSERT INTO Cliente (ativo, nome, cpf, data_nasc, phone, endereco, email, senha, dt_criacao)
...
VALUES (1, 'poupanca', 500, null, null, 5000, 5000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (2, 'corrente', 3000, null, null, 8000, 14000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (3, 'poupanca', 1100, null, null, 5000, 7000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (4, 'corrente', 100, null, null, 5000, 2000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (5, 'poupanca', 9000, null, null, 5000, 30000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (6, 'corrente', 89000, 300, null, 5000, 200000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (7, 'corrente', 300, 30, null, 7000, 20000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (8, 'corrente', 150000, null, null, 500000, 550000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (9, 'poupanca', 15000, null, null, 5000, 5000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (10, 'corrente', 58000, null, 2300, 150000, 50000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (11, 'corrente', 500, null, null, 2000, 5000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (12, 'corrente', 200000, 3000, 4000, 300000, 500000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (13, 'corrente', 45000, 559, null, 90000, 300000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (14, 'corrente', 500, null, null, 3000, 5000)
INSERT INTO Conta (id_cliente, tp_conta, saldo_real, saldo_dolar, saldo_euro, lim_credito, lim_emprest)
VALUES (15, 'corrente', 500, 800, null, 3500, 7000)
...
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(1, 9, '2022-10-14', 'Débito', 'Aprovado', 50);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(7, 7, '2022-11-15', 'Depósito', 'Negado', 3000);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(8, 8, '2022-11-16', 'Depósito', 'Aprovado', 2200);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(13, 13, '2022-11-17', 'Crédito', 'Aprovado', 150);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(11, 11, '2022-11-18', 'Crédito', 'Aprovado', 3300);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(1, 11, '2022-11-19', 'Débito', 'Aprovado', 1000);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(7, 3, '2022-12-20', 'Débito', 'Negado', 10000);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(11, 12, '2022-12-21', 'Débito', 'Aprovado', 9000);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(6, 7, '2022-12-22', 'Débito', 'Aprovado', 200);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(15, 7, '2022-12-23', 'Débito', 'Negado', 1000);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(4, 4, '2022-12-02', 'Débito', 'Aprovado', 1500);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(2, 4, '2023-01-03', 'Crédito', 'Aprovado', 800);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(6, 10, '2023-01-04', 'Crédito', 'Aprovado', 750);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(10, 11, '2023-01-05', 'Crédito', 'Aprovado', 500);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(15, 2, '2023-01-06', 'Crédito', 'Aprovado', 3500);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(14, 4, '2023-01-07', 'Crédito', 'Aprovado', 230);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(4, 4, '2023-01-06', 'Crédito', 'Aprovado', 4500);
INSERT INTO Transacao (id_conta, id_cliente, data, tp_trans, status, valor)
VALUES(15, 10, '2021-01-07', 'Crédito', 'Negado', 230);
